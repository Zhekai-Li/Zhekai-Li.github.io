...
My current research is primarily centered on the value of **Exploration** and **Adaptivity** in **Sequential Decision-Making**, with a special focus on proactively seeking informative feedback and uncovering unknown attributes in the environment. The exploration of adaptive sequential decision-making has gradually gained attention due to the pressing need for approaches that are not only effective today but also prepare systems to handle future uncertainties.
 <!-- and **ambulance dispatch** -->

 I am currently working on the **pure exploration pronlem** in **AI Drug Discovery (AI-DD)**. **"Ensuring healthy lives and promoting the well-being at all ages is essential to sustainable development."** The fusion of **sequential decision-learning** and **healthcare problems** has received extensive attention under the urgent need for more efficient and effective approaches to disease prevention, life extension, and population health improvement, as well as treating disease, bringing revolutionary changes to the development pattern of the healthcare system all around the world and influencing everyone's life. I am deeply committed to this meaningful cause, dedicated to bring even the slightest well-being to the world.<br/>
